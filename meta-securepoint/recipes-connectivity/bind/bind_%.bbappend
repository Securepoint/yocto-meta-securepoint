...
PACKAGES_prepend += " ${PN}-lwresd ${PN}-utils-host ${PN}-utils-dig ${PN}-libs-export ${PN}-utils-rdnc ${PN}-utils-python "

PACKAGECONFIG = ""
EXTRA_OECONF += " --disable-full-report --disable-backtrace --disable-static --enable-shared --with-libtool "
