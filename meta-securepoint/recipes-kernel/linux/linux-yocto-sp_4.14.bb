...
FILESEXTRAPATHS_prepend := "${THISDIR}/linux-4.14:${THISDIR}/files:"

SRC_URI = "\
	gitsm://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git;branch=linux-4.14.y;bareclone=1;protocol=http \
	file://i915.cfg \
"
