...
do_install() {
    ...
    cp -a --no-preserve=ownership ${WORKDIR}/firmware-nonfree-${PV}/rtl_nic   ${D}/lib/firmware
    cp -a --no-preserve=ownership ${WORKDIR}/firmware-nonfree-${PV}/bnx2      ${D}/lib/firmware
    cp -a --no-preserve=ownership ${WORKDIR}/firmware-nonfree-${PV}/bnx2x     ${D}/lib/firmware
    cp -a --no-preserve=ownership ${WORKDIR}/firmware-nonfree-${PV}/ath6k     ${D}/lib/firmware
    cp -a --no-preserve=ownership ${WORKDIR}/firmware-nonfree-${PV}/ath10k    ${D}/lib/firmware
}
